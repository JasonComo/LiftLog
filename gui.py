...
class GUI:
    ...
    def createEditFrame(self):
        ...
        for i in range(num_workouts):
            rely = 0.35 + (i * 0.5) / num_workouts  
            edit_button = Button(self.edit_frame, background="white", image=blank_btn, text=self.account.workouts[i].name, activebackground="white", activeforeground="white", compound="center", bg="white", fg="white", font=arial_2, borderwidth=0, command=lambda workout_num=i: editWorkout(workout_num))
